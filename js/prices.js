...
// Fetch exchange rate data and cache
...
// Update a single element with value and trend
function updateElement(id, info) {
  ...
  if (valEl && info) {
    ...
    if (trendContainer) {
      ...
      trendContainer.classList.remove(
        "trend-up",
        "trend-down",
        "trend-neutral",
      );
